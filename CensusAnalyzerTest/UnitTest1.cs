...
namespace CensusAnalyzerTest
{
    public class Tests
    {
        ...
        static string indianStateCodeFilePath = @"C:\Users\91790\Desktop\dotnet\IndianStateCensusAnalyzer\CensusAnalyzerTest\CsvFiles\IndiaStateCode.csv\";
        ...
        public void GivenWrongIndianCensusDataFile_WhenReaded_ShouldReturnCustomException()
        {
            ...
            var stateException = Assert.Throws<CensusAnalyserException>(() => censusAnalyser.LoadCensusData(wrongHeaderStateCodeFilePath, CensusAnalyser.Country.INDIA, indianStateCodeHeaders));
